$(function() {
  ...
  var texture = new THREE.TextureLoader().load('barrel_rust.jpg' );
  ...
  //Ground
  grasstexture;
  var planeGeometry = new THREE.PlaneGeometry(50,50,30);
  ...
  //
  // var cylinderMaterial = new THREE.MeshBasicMaterial( { map: texture } );


  var barrel = new THREE.Mesh(cylinderGeometry, cylinderMaterial);
